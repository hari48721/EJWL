...
<td>
	<ul class="icons-list">
	<li class="dropdown">
	<li><a href="<?=site_url('Account_Master/Grp_Master_Edit/'.$row['gid'])?>"><i class=" icon-pencil5 position-left"></i>Edit</a></li>
	<li><a href="<?=site_url('Account_Master/Grp_Master_Delete/'.$row['gid'])?>"><i class="icon-cross2 position-left"></i>Delete</a></li>
	</li>
	</ul>
</td></tr>
<?php endforeach ?>

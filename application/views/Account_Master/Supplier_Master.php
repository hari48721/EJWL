...
<head><h5><center>SUPPLIER MASTER ENTRY</center></h5><button type="submit" class="btn bg-slate"><i class="icon-file-plus position-left"></i> Add</button>
<a href="<?=site_url('Account_Master/Supplier_Master')?>" id="button"class="btn btn-info btn-xs"><i class="icon-new position-left"></i>New</button></a>
<a id="button" href="<?=site_url('Account_Master/Supplier_Master_View')?>" class="btn bg-info"><i class="icon-pencil5 position-left"></i> Edit</a>
<a  id="button"href="<?=site_url('Account_Master/Supplier_Master_View')?>" class="btn bg-info"><i class="icon-bin position-left"></i> Delete</a>
...
<div id="item2">
<input type="hidden"   name="accgrp" value="53">
</div>

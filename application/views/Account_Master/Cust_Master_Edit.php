...
<head><h5><center>CUSTOMER MASTER ENTRY</center></h5><button type="submit" class="btn bg-slate"><i class="icon-spinner9 position-left"></i> Update</button>
	<a id="button" href="<?=site_url('Account_Master/Customer_Master_View')?>" class="btn bg-info"><i class="icon-book3 position-left"></i> View All</a>
...
<div id="item1">
Account Name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <input type="text" style="height: 28px; width:350px; "  name="accname"  value="<?php echo $query->accName; ?>" required autofocus>
</div>
<div id="item2">
...
<input type="radio"   id="inlineRadio2" value="<?php echo set_value('OpBalDC','C')?>" name="OpBalDC" <?php if($query->Credit == 'C' ) { echo 'checked'; } ?> >Credit&nbsp;&nbsp;
<input type="radio"  id="inlineRadio1" value="<?php echo set_value('OpBalDC','D')?>" name="OpBalDC" <?php if($query->Credit == 'D' ) { echo 'checked'; } ?>>Debit
</div>
...
<div id="item6">
Contact Person:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" style="height: 28px; width:350px; "  name="cper" value="<?php echo $query->cperson; ?>">
</div>
...
<div id="item10">
Pin Code:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" style="height: 28px; width:200px; "  name="pcode" value="<?php echo $query->pincode; ?>"></div>
...
<div id="item11">
State:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <input type="text" style="height: 28px; width:200px; "  name="state" value="<?php echo $query->state; ?>">
<input type="radio" value="O" name="stype" <?php if($query->stype == 'O'){ echo "checked" ;} ?>>Others&nbsp;&nbsp;
<input type="radio" value="L" name="stype" <?php  if($query->stype == 'L'){ echo "checked" ;}?> >Local</div>

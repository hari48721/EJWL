...
<head><h5><center>ITEM MASTER ENTRY</center></h5>
...
<td>
	<ul class="icons-list">
	<li class="dropdown">
	<li><a href="<?=site_url('Account_Master/Item_Master_Edit/'.$row['id'])?>"><i class=" icon-pencil5 position-left"></i>Edit</a></li>
	<li><a href="<?=site_url('Account_Master/Item_Master_Delete/'.$row['id'])?>"><i class="icon-cross2 position-left"></i>Delete</a></li>
	</li>
	</ul>
</td></tr>
<?php endforeach ?>

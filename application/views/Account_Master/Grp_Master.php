...
<form action="<?=site_url('Account_Master/Grp_Master_Insert')?>" method="POST">
<head><h5><center>Group Master</center></h5><button type="submit" class="btn bg-slate"><i class="icon-file-plus position-left"></i> Add</button>
	<a href="<?=site_url('Account_Master/Group_Master')?>" id="button"class="btn btn-info btn-xs"><i class="icon-new position-left"></i>New</button></a>
	<a id="button" href="<?=site_url('Account_Master/Group_Master_View')?>" class="btn bg-info"><i class="icon-pencil5 position-left"></i> Edit</a>
	<a  id="button"href="<?=site_url('Account_Master/Group_Master_View')?>" class="btn bg-info"><i class="icon-bin position-left"></i> Delete</a>
...
<div id="item">
Group Name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <input type="text"style="height: 28px; width:350px; " name="grpname" autofocus required>

</div>

<div id="item2">
	Group Type: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select id="select" style="height: 28px; width:350px; " class="countries" name="grptyp">
<option>--Select Your Category--</option>
<?php foreach ($query as $row ): ?> 
<option value="<?=$row['gtid']?>" <?php echo set_select('grp_type', $row['gtid']); ?>> 
<?=$row['grp_type']?></option> 
	<?php endforeach ?>
</select></div>

...
<head><h5><center>SUPPLIER MASTER ENTRY</center></h5>
  <a href="<?=site_url('Account_Master/Supplier_Master')?>" id="button" class="btn btn-info btn-xs"><i class="icon-cross2 position-left"></i>Cancel</a>
</head>
<body>
...
<td>
  <ul class="icons-list">
  <li class="dropdown">
  <li><a href="<?=site_url('Account_Master/Supplier_Master_Edit/'.$row['id'])?>"><i class=" icon-pencil5 position-left"></i>Edit</a></li>
  <li><a href="<?=site_url('Account_Master/Supplier_Master_Delete/'.$row['id'])?>"><i class="icon-cross2 position-left"></i>Delete</a></li>
  </li>
  </ul>
</td></tr>
<?php endforeach ?>
